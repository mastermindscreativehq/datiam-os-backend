...
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "ai_recs_type_idx" ON "ai_recommendations" USING btree ("recommendation_type");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "ai_recs_entity_type_idx" ON "ai_recommendations" USING btree ("entity_type");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "scheduled_jobs_status_idx" ON "scheduled_jobs" USING btree ("status");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "scheduled_jobs_type_idx" ON "scheduled_jobs" USING btree ("job_type");--> statement-breakpoint
